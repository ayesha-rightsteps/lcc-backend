...
import { getAllContent, getMyContent, createContent, manageAccess, streamContent } from '../controllers/content.controller.js';

const router = express.Router();

router.get('/', authenticate, isAdmin, getAllContent);
